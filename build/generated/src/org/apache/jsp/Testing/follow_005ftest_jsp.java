...
public final class follow_005ftest_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Statement stmt_topic,stmt_topic_followers=null;
 Connection con_topic,con_topic__followers;
 ResultSet rs_topic,rs_topic_followers;
 String name_topic;   
      ...
      out.write("              ");
              ...
              while (rs_topic_followers.next()){
                  ...
                  if(f_topic_id == topic_id && f_followers_id == id_of_user ){
                      out.println("<br>Followed Topic = "+name_topic);
                  }
