    ...
    <body>
        ...
        <div class="row">
            <div class="column side">
                ...
                <ul class="a">
                    <a href="settings.jsp?Q_value=Account"><li>Account</li></a>
                    <a href="settings.jsp?Q_value=Privacy"><li>Privacy</li></a>
                    <a href="settings.jsp?Q_value=D_Zone"><li style=color:red;>Danger Zone</li></a>
                </ul>
            </div>
            <div class="column middle">
                ...
                <%
                    ...
                    if(ParametrVariable == null){
                         ParametrVariable = "Account";
                    }
                     if (ParametrVariable != null) {
                        if (ParametrVariable.equals("Account")) {
                            out.print("<b>--------------------Account----------------------------</b><br>");%>
                            <b><a href="ChangeEmail.jsp">@change your mail address</a></b><br>
                            <b><a href="ChangePassword.jsp">@change your password</a></b>
                       <% }
                       
                       if (ParametrVariable.equals("D_Zone")) {
                            out.print("<b>--------------------Account----------------------------</b><br>");%>
                            <b><a href="DeleteUserAccount.jsp">@Delete Your Account</a><b style=color:red;> Not Recomended</b></b><br>
                          <% }
